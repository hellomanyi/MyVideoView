...
public class VideoView extends TextureView implements android.view.TextureView.SurfaceTextureListener {
	...
	public void setAssetPath(AssetFileDescriptor fileDescriptor) {
		// && MediaUtils.isNative(path)
		if (fileDescriptor != null) {
			mTargetState = STATE_PREPARED;
			openVideo(fileDescriptor);
		}
	}
	...
	@SuppressLint("NewApi")
	@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
	public void openVideo(AssetFileDescriptor fileDescriptor) {
		if (fileDescriptor == null || mSurfaceHolder == null || getContext() == null) {
			// not ready for playback just yet, will try again later
			if (mSurfaceHolder == null && fileDescriptor != null) {
